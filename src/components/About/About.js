    ...
    <section id="about">
      <Container>
        ...
        <Row>
          ...
          <Col lg={9} sm={12}>
            <dl>
              <dt>소개</dt>
              <dd>
                안녕하세요. 풀스택 개발자로 이전 직장에서 1년 4개월 근무하였습니다. <br />
                GIS 회사로 지도 화면상의 기능구현을 주로 하기 때문에 JavaScript를 많이 사용하였습니다. <br />
                그래서 간단하고 빠른 JavaScript의 매력에 푹 빠져 Front-End 개발자로 전향하고자 합니다. 또한, 보이지 않는
                기능보다는 사용자에게 직접 보이는 화면을 구성하는 것에 더 흥미를 느꼈습니다. <br />
                어렸을때부터 해보지도 않은 일을 지레 겁먹어 포기하지 않고 새로운 일을 시도하는 도전정신이 강했습니다. 그
                결과로 퇴사 이후에는 해보지 않은 기술인 React와 node를 혼자 학습하여 개인 프로젝트를 만들었습니다. 빠른
        ...
        <div className="about-continue">
          ...
          <NavLink href="#skills" duration={1000}>
